                            ...
                            <div class="row">
                                    ...
                                    <div class="card card-member">
                                        <div class="content">
                                            <div class="avatar avatar-danger">
                                                <img alt="..." class="img-circle" src="{{ asset('/img/faces/face_1.jpg') }}"/>
                                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card card-member">
                                        <div class="content">
                                            <div class="avatar avatar-danger">
                                                <img alt="..." class="img-circle" src="{{ asset('/img/faces/face_4.jpg') }}"/>
                                            </div>
                                            <div class="description">
                                ...
                                <div class="col-md-4">
                                    <div class="card card-member">
                                        <div class="content">
                                            <div class="avatar avatar-danger">
                                                <img alt="..." class="img-circle" src="{{ asset('/img/faces/face_3.jpg') }}"/>
                                            </div>
                                            <div class="description">
